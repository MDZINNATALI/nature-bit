...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'nature-bit-secret-key-2026'
...
if __name__ == '__main__':
    with app.app_context():
        ...
        # এডমিন ইউজার তৈরি করুন (যদি না থাকে)
        ...
        # স্যাম্পল গাছ যোগ করুন (যদি না থাকে)
        if Plant.query.count() == 0:
            plants = [
                Plant(
                    ...
                    category='ইনডোর',
                    description='বাতাস বিশুদ্ধকারী, সহজে বাঁচে। খুব কম যত্নে হয়।',
                    price=350,
                    old_price=450,
                    stock=15,
                ...
                Plant(
                    ...
                    category='ফুল',
                    description='সুগন্ধি ফুল, বাগানের রানী। বিভিন্ন রঙের হয়।',
                    price=250,
                    stock=10,
                ...
                Plant(
                    ...
                    category='ঔষধি',
                    description='ত্বকের যত্নে, রসে ভরপুর। ঔষধি গুণসম্পন্ন।',
                    price=180,
                    stock=20,
                    light_requirement='পূর্ণ সূর্য',
                ...
                Plant(
                    ...
                    category='ইনডোর',
                    description='ভাগ্যবৃদ্ধি করে বলে বিশ্বাস। সহজে বাঁচে।',
                    price=450,
                    old_price=550,
                    stock=8,
                    light_requirement='আংশিক ছায়া',
